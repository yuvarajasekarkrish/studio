        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-3xl md:text-4xl font-headline font-bold text-primary mb-4">
              About Maharaj Pyrotech
            </h2>
            <p className="mb-4 text-lg">
              With a legacy forged in fire and a passion for celebration, Maharaj Pyrotech has been illuminating skies for over two decades. Our journey began with a simple mission: to bring joy and wonder to people's most cherished moments through the art of pyrotechnics.
            </p>
            <p className="mb-4">
          ...
          <div className="order-1 md:order-2">
            <div className="rounded-lg overflow-hidden shadow-2xl">
                <Image
                    ...
                    alt="Diwali sale banner for Maharaj Pyrotech"
                    width={600}
                    height={450}
